// app/components/room-types/RoomTypeByHotelFilters.jsx
"use client"
...
export function RoomTypeByHotelFilters({ filters, onFiltersChange }) {
    const [facilities, setFacilities] = useState([])
    const [loading, setLoading] = useState(false)

    useEffect(() => {
        getRoomTypeFacilities().then(setFacilities)
    }, [])
